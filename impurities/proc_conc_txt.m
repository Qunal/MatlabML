%% Machine Learning for Mining - Text File Version
...
%
% Input data is a mix of conc_chem.txt & conc_in.txt
% Output data is conc_out.txt
%
...
%% load target data
conc_out = readtable('conc_out.txt');
...
conc_chem = readtable('conc_chem.txt');
