function createfigure(data1, data2, S1, C1)
%CREATEFIGURE(DATA1,DATA2,S1,C1)
%  DATA1:  scatter x
%  DATA2:  scatter y
%  S1:  scatter s
%  C1:  scatter c

%  Auto-generated by MATLAB on 03-Nov-2011 15:51:21
...
% Create scatter
scatter1 = scatter(data1,data2,S1,C1,'Parent',axes1,...
    'DisplayName','data.SYSLoad vs data.DryBulb');
