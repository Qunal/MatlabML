...
-mrproj_1_0.dll (output from mcc)
-mrproj.bas (VBA module file created by mcc)
-mrproj.xla (Excel AddIn file created by mcc)
-MCRInstaller.exe
...
NOTE: Verify mrproj_1_0.dll is registered on the target machine. If you have trouble 
