...
{
  {
    ...
    CClass1::GetClassObject, "Class1", "mrproj.Class1", "mrproj.Class1.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
static void initialize_path()
{
    ...
    build_mclmcrrt_name("8","2","0",mclmcrrt_name);
...
{
  initialize_path();
  return g_pModule->InitMain(objectmap, &LIBID_mrproj, 1, 0, hInstance, dwReason, pv);
}
