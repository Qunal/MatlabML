...
#ifndef __fault_detect_idl_h__
#define __fault_detect_idl_h__
...
EXTERN_C const IID IID_IClass1;
    ...
    MIDL_INTERFACE("7E226D48-2672-458E-8202-0F04B12D9771")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE steelfault( 
            /* [in] */ long nargout,
            /* [out][in] */ VARIANT *out,
            /* [in] */ VARIANT in) = 0;
    ...
    typedef struct IClass1Vtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *steelfault )( 
            IClass1 * This,
            /* [in] */ long nargout,
            /* [out][in] */ VARIANT *out,
            /* [in] */ VARIANT in);
...
#define IClass1_steelfault(This,nargout,out,in)	\
    ( (This)->lpVtbl -> steelfault(This,nargout,out,in) ) 
...
#ifndef __fault_detect_LIBRARY_DEFINED__
#define __fault_detect_LIBRARY_DEFINED__

/* library fault_detect */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_fault_detect;

EXTERN_C const CLSID CLSID_Class1;

#ifdef __cplusplus

class DECLSPEC_UUID("CB1EBE8D-E218-4CC1-BB12-C42FDB0283B8")
Class1;
#endif
#endif /* __fault_detect_LIBRARY_DEFINED__ */
