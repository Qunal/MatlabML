...
/* at Thu Jul 03 13:27:23 2014
 */
/* Compiler settings for C:\AE\miningmachine\steelplates\fault_detect\for_testing\fault_detect_idl.idl:
...
typedef struct _fault_detect_idl_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } fault_detect_idl_MIDL_TYPE_FORMAT_STRING;

typedef struct _fault_detect_idl_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } fault_detect_idl_MIDL_PROC_FORMAT_STRING;

typedef struct _fault_detect_idl_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } fault_detect_idl_MIDL_EXPR_FORMAT_STRING;
...
extern const fault_detect_idl_MIDL_TYPE_FORMAT_STRING fault_detect_idl__MIDL_TypeFormatString;
extern const fault_detect_idl_MIDL_PROC_FORMAT_STRING fault_detect_idl__MIDL_ProcFormatString;
extern const fault_detect_idl_MIDL_EXPR_FORMAT_STRING fault_detect_idl__MIDL_ExprFormatString;
...
static const fault_detect_idl_MIDL_PROC_FORMAT_STRING fault_detect_idl__MIDL_ProcFormatString =
    {
        0,
        {
...
static const fault_detect_idl_MIDL_TYPE_FORMAT_STRING fault_detect_idl__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IClass1, ver. 0.0,
   GUID={0x7E226D48,0x2672,0x458E,{0x82,0x02,0x0F,0x04,0xB1,0x2D,0x97,0x71}} */
...
static const MIDL_STUBLESS_PROXY_INFO IClass1_ProxyInfo =
    {
    &Object_StubDesc,
    fault_detect_idl__MIDL_ProcFormatString.Format,
...
CINTERFACE_PROXY_VTABLE(11) _IClass1ProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IClass1::steelfault */ ,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    fault_detect_idl__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _fault_detect_idl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IClass1ProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _fault_detect_idl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IClass1StubVtbl,
    0
};

PCInterfaceName const _fault_detect_idl_InterfaceNamesList[] = 
{
    "IClass1",
    0
};

const IID *  const _fault_detect_idl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _fault_detect_idl_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _fault_detect_idl, pIID, n)

int __stdcall _fault_detect_idl_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_fault_detect_idl_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo fault_detect_idl_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _fault_detect_idl_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _fault_detect_idl_StubVtblList,
    (const PCInterfaceName * ) & _fault_detect_idl_InterfaceNamesList,
    (const IID ** ) & _fault_detect_idl_BaseIIDList,
    & _fault_detect_idl_IID_Lookup, 
    1,
    2,
